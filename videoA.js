...
function addMenu (option){
    ...
    elem.id = 'menu01';
    elem.innerHTML = ` <button class="actionButton" onclick="${option.action1}" ><i class="fas fa-microphone"></i>${option.nameOfButton1} </button>
    <button class="actionButton" onclick="${option.action2}"><i class="fas fa-file-pdf"></i> ${option.nameOfButton2}</button> 
    <button class="actionButton " onclick="${option.action3}"> <i class="fas fa-pen"></i>   ${option.nameOfButton3} </button>`
